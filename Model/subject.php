<?php require 'database.php';
    ...
    if (!$conn){
        echo "Subject Table Connection Failure"."<br>";
    }	
...
// IMPORTANT NOTE --> this variable, $subject, is what holds all the data returned and what you'll use to access specific record fields in your display via php echo statments in movie.php line #
$subject = mysqli_fetch_all($result, MYSQLI_ASSOC); // you will rename your variable for each specific query
